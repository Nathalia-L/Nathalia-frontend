  ...
  return (
    <div className="w-full lg:w-80 flex flex-col gap-4">
        ...
        <div className="px-6 py-4 flex flex-col gap-3">
          ...
          {descuentoFuente && (
            <div className="flex justify-between">
              ...
              <span className="text-sm text-[#EBC6D6]">- ${descuentoMonto.toLocaleString()}</span>
            </div>
          )}
          {!descuentoFuente && !esJuridica && unidadesFaltantes > 0 && (
            <div className="text-xs text-[#EBC6D6] bg-[#C77A9C]/10 border border-[#C77A9C]/20 rounded-lg px-3 py-2">
      ...
      <button
        ...
        className="w-full bg-[#C77A9C] text-white text-sm font-semibold py-3 rounded-xl flex items-center justify-center gap-2 hover:bg-[#A65E80] transition-colors"
      >
        ⚙️ Configurar pedido
      </button>

      {/* Compra segura */}
      <div className="rounded-xl border border-white/[0.08] bg-[#241219] py-3 px-6 flex items-center justify-center gap-3">
