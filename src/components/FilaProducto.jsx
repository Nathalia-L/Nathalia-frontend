  ...
  return (
    <div className="grid grid-cols-[1fr_auto_auto] sm:grid-cols-3 items-center gap-3 px-4 sm:px-6 py-5 border-b border-white/[0.07] last:border-b-0">
      ...
      <div className="flex items-center gap-4 min-w-0">
        <ImagenProducto src={imagen} alt={nombre} className="w-14 h-14 rounded-lg object-cover bg-[#2A1521] shrink-0" />
      ...
      <div className="flex items-center justify-self-end gap-2">
        <div className="flex items-center bg-[#241219] border border-white/10 rounded-lg">
          <button
            type="button"
        ...
        <button
          ...
          className="w-8 h-8 rounded-lg bg-white/[0.05] border border-white/10 text-white/40 hover:text-[#D4AF37] hover:border-[#D4AF37]/40 text-xs transition-colors flex items-center justify-center"
