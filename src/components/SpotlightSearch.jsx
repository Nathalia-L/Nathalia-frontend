  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-lg bg-[#241219] border border-white/[0.12] rounded-2xl shadow-2xl shadow-black/40 overflow-hidden"
            ...
            {resultados.length > 0 ? (
              <ul className="py-2">
                {resultados.map((p, i) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg overflow-hidden bg-[#2A1521] shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {p.promoPct > 0 && (
                          <span className="text-[10px] font-bold text-[#D4AF37]">-{p.promoPct}%</span>
                        )}
                      </div>
                    </div>
                    ...
                    {p.disponible && (
                      <button
                        ...
                        className="shrink-0 h-7 px-2.5 rounded-lg bg-[#C77A9C] text-white text-[11px] font-semibold hover:bg-[#A65E80] transition"
                      >
                        + 🛒
                      </button>
                    )}
