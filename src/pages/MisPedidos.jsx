...
// Ícono oficial de WhatsApp (glifo sobre viewBox 24x24)
                    ...
                    <div className="text-right shrink-0 flex flex-col items-end gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-lg bg-[#25D366]/15 px-3 py-2 text-xs font-semibold text-[#128C7E] hover:bg-[#25D366] hover:text-white transition"
                        >
                        ...
                        <button
                          ...
                          aria-label="Eliminar de mi historial"
                          onClick={() => {
                            if (window.confirm('¿Eliminar este pedido de tu historial?')) {
                              eliminarPedidoLocal(ped.id)
                              setPedidosLocales(cargarPedidosLocales())
                            }
                          }}
                          className="w-8 h-8 rounded-lg bg-elevated border border-line text-ink-3 hover:text-white hover:bg-error/80 hover:border-error transition flex items-center justify-center"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
