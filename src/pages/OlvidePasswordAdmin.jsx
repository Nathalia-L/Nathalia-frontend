    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl p-8" style={{ background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.15)' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={cargando} className="w-full py-2.5 bg-[#C77A9C] text-white rounded-xl text-sm font-medium hover:bg-[#A65E80] transition disabled:opacity-50 mb-4">
            {cargando ? 'Enviando...' : 'Enviar enlace'}
          </button>

          <p className="text-center text-sm text-white/50">
            <button type="button" className="text-[#EBC6D6] cursor-pointer hover:underline bg-transparent border-0 p-0 font-inherit" onClick={() => navigate('/control-interno')}>
