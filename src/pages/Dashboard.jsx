                      ...
                      <div className="w-full flex items-end" style={{ height: '160px' }}>
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor: item.destacado ? '#0c3d2a' : '#C77A9C',
                          }}
                        ></div>
                      </div>
                      ...
                      <tr key={c.email} className="border-b border-[#eef4ef] last:border-0">
                        <td className="py-3">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#C77A9C] to-[#0d6e46] flex items-center justify-center text-white text-xs font-medium flex-shrink-0">
                              {c.nombre.charAt(0)}
                            </div>
                            <div>
              ...
              {productosMasVendidos.map((p) => (
                <div key={p.nombre} className="flex items-center gap-3">
                  {p.imagen ? (
                    ...
                    <div className="w-14 h-14 rounded-lg bg-[#C77A9C] flex-shrink-0"></div>
                  )}
