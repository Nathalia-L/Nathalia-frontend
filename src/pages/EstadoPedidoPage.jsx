...
function EstadoPedidoPage() {
  ...
  if (cargando) return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#1A0E13' }}>
    ...
    <div className="min-h-screen" style={{ background: '#1A0E13' }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 text-white">
        ...
        <div className="flex items-center gap-3 mb-1">
          ...
          <span className="bg-[#C77A9C] text-white text-xs px-3 py-1 rounded-full font-medium">
          ...
          <div className="rounded-xl border border-white/15 bg-white/[0.08] backdrop-blur-xl p-6">
            ...
            <div className="flex flex-col gap-3 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-[#EBC6D6] font-medium">{pedido.metodo_pago}</span>
              </div>
  ...
  <div key={i} className="flex items-center gap-3">
    <div className="w-8 h-8 bg-[#C77A9C]/15 rounded-lg flex items-center justify-center text-sm">☕</div>
    <div className="flex-1">
      ...
      {pedido.estado === 'entregado' && resenaAbierta !== p.id_detalle && (
        <button
          ...
          className="text-[10px] text-[#EBC6D6] hover:underline block mt-1"
        >
          Escribir reseña →
        </button>
      )}
    ...
    <span className="text-xs text-white/40">{p.cantidad} und</span>
        ...
        <div className="rounded-xl border border-white/15 bg-white/[0.08] backdrop-blur-xl px-6 py-4 flex items-center gap-4">
          <div className="w-8 h-8 bg-[#C77A9C]/15 rounded-full flex items-center justify-center text-sm flex-shrink-0">
            🛡️
          </div>
          <div>
        ...
        <button
          ...
          className="mt-6 flex items-center gap-2 text-[#EBC6D6] text-sm hover:underline"
        >
          ← Volver al historial
        </button>
