...
function ComparacionPage() {
  ...
  if (error) return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-3" style={{ background: '#1A0E13' }}>
      <p className="text-[#D4AF37] text-sm">{error}</p>
      <Link to="/cliente/catalogo" className="text-[#EBC6D6] text-sm hover:underline">← Volver al catálogo</Link>
    </div>
  )
